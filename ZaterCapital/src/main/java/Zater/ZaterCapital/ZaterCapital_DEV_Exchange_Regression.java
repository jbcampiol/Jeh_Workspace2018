...
public class ZaterCapital_DEV_Exchange_Regression extends FuncoesReusaveis_Windows {
	...
	public static void AbrirBrowser() throws Exception {
		...
		/** Report Extent **/
		test.log(Status.INFO, "STP00_AbrirBrowser");
	...
	public static void STP01_000_LogarExchange() throws Exception {
		...
		if (IsElementPresent("Page-1")) {
			...
			if (IsElementPresent("inputEmail3")) {
				...
				// Digitando o Usuário
				//login.sendKeys(Dados.Homologacao_Exchange_EMAIL);
				login.sendKeys(User);
				...
				//System.out.println("Usuário: " + Dados.Homologacao_Exchange_EMAIL);
			...
			if (IsElementPresent("inputPassword3")) {
				...
				// Digitando a Senha
				//password.sendKeys(Dados.Homologacao_Exchange_Senha);
				...
				//System.out.println("Senha: " + Dados.Homologacao_Exchange_Senha);
		...
		if(IsElementPresent("//*[@class='al-sidebar-list-link ng-scope']")) {
			...
			if(driver.findElement(By.xpath("//*[@class='al-title ng-binding']")).getAttribute("innerText").contains("MINHA CARTEIRA") && IsElementPresent("mywallet")) {
				...
				if(IsElementPresent("//*[@class='row my-wallet ng-scope']")) {
					...
					/** Report Extent **/
					test.log(Status.ERROR, "'Carteiras e Moedas' - Visivel");
					test.addScreenCaptureFromPath(TakeScreenshot("Erro","STP03_000_Navegar_Minha_Carteira-CarteirasEMoedasVisivel"));
					/** Report Extent **/
	...
	public static void STP05_002_Confirmar_Depositos_Dinheiro() throws Exception {
		...
		if (IsElementPresent("modal-dialog")) {
			...
			if (IsElementPresent("/html/body/div[1]/div/div/div/form/div/div[2]/button[2]")) {
			...
			if(IsElementPresent("history")) {
				...
				if (IsElementSelected("historyType")) {
			        ...
			        if(IsElementPresent("//*[@id='history']/div[2]/div/div/h3")) {
				        ...
				        /** Report Extent **/
						test.log(Status.PASS, "Texto - Não Visivel");
						test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","STP03_000_Navegar_Historico-TextoNãoVisivel"));
						/** Report Extent **/
	...
	public static void FecharBrowser() throws Exception {
		...
		/** Report Extent **/
		test = extent.createTest("ZaterCapital_DEV_Exchange_Regression_Finalizar");
		test.assignCategory("Regressão");
		/** Report Extent **/

		/** Report Extent **/
		test.log(Status.PASS, "Browser Encerrado com Sucesso");
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","ZaterCapital_DEV_Exchange_Regression_Finalizar-EncerrarSiteComSucesso"));
		/** Report Extent **/
