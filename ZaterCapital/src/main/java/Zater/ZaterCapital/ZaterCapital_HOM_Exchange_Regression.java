...
public class ZaterCapital_HOM_Exchange_Regression extends FuncoesReusaveis_Windows {
	...
	public static void AbrirBrowser() throws Exception {
		...
		/** Report Extent **/
		StartReport("ZaterCapital_HOM_Exchange_Regression");	
	...
	public static void FecharBrowser() throws Exception {
		...
		/** Report Extent **/
		test = extent.createTest("ZaterCapital_HOM_Exchange_Regression_Finalizar");
		test.assignCategory("Regressão");
		/** Report Extent **/

		/** Report Extent **/
		test.log(Status.PASS, "Browser Encerrado com Sucesso");
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","ZaterCapital_HOM_Exchange_Regression_Finalizar-EncerrarSiteComSucesso"));
		/** Report Extent **/
