...
public class ZaterCapital_PROD_SiteZater_Regression extends FuncoesReusaveis_Windows {
	...
	public static void main(String[] args) throws Exception {
		...
		STP00_Json();
		STP01_Navegar_HOME();
		STP02_Navegar_SobreNos();
		STP03_Navegar_Vantagens();
		STP04_Navegar_APresidencia();
		STP05_Navegar_Bitcoin();
		STP06_Navegar_Bitcoin_VoceSabe();
		STP07_Navegar_Bitcoin_ComoCompraBitcoin();
		STP08_Navegar_Bitcoin_ComoVenderBitcoin();
		STP09_Navegar_Bitcoin_ValeInvestir();
		STP10_Navegar_Seguranca();
		STP11_Navegar_Taxas();
		STP12_Navegar_CentralAjuda();
		STP13_Navegar_Contato();
		STP14_Navegar_Cadastrar();
		STP15_Navegar_Logar();
		STP16_Navegar_TermosUso();
		STP17_Navegar_PoliticaPrivacidade();
		FecharBrowser();
    ...
    @Test
	public static void STP00_Json() throws Exception {
	...
	@Test
	public static void STP01_Navegar_HOME() throws Exception {
	...
	@Test
	public static void STP02_Navegar_SobreNos() throws Exception {
	...
	@Test
	public static void STP03_Navegar_Vantagens() throws Exception {
	...
	@Test
	public static void STP04_Navegar_APresidencia() throws Exception {
	...
	@Test
	public static void STP05_Navegar_Bitcoin() throws Exception {
	...
	@Test	
	public static void STP06_Navegar_Bitcoin_VoceSabe() throws Exception {
	...
	@Test
	public static void STP07_Navegar_Bitcoin_ComoCompraBitcoin() throws Exception  {
	...
	@Test	
	public static void STP08_Navegar_Bitcoin_ComoVenderBitcoin() throws Exception {
	...
	@Test
	public static void STP09_Navegar_Bitcoin_ValeInvestir() throws Exception {
	...
	@Test
	public static void STP10_Navegar_Seguranca() throws Exception {
	...
	@Test
	public static void STP11_Navegar_Taxas() throws Exception {
		...
		if (IsElementPresent("Taxas")) {// Verificando se o elemento é verdadeiro
			...
			// Verifica se o Texto é verdadeiro
			//assertTrue(driver.findElement(By.id("taxes")).getText().contains("Taxas e Prazos da ZaterX"));
			//assertTrue("ZaterX", true);
			//assertEquals("ZaterX", driver.findElement(By.xpath("//*[@id='banner']/div/div[2]/div[1]/div/div/div/div/div/h1")).getText());
			
			// Escrevendo no Console
			System.out.println("Assert: " + driver.findElement(By.id("taxes")).getText().contains("Taxas e Prazos da ZaterX"));
			System.out.println("Assert: " + driver.findElement(By.id("taxes")).getText());
			
			/** Report Extent **/
			test.log(Status.PASS, "Taxas - Vis�vel");
	...
	@Test
	public static void STP12_Navegar_CentralAjuda() throws Exception {
	...
	@Test
	public static void STP13_Navegar_Contato() throws Exception {
	...
	@Test
	public static void STP14_Navegar_Cadastrar() throws Exception {
	...
	@Test
	public static void STP15_Navegar_Logar() throws Exception {
	...
	@Test
	public static void STP16_Navegar_TermosUso() throws Exception {
	...
	@Test
	public static void STP17_Navegar_PoliticaPrivacidade() throws Exception {
