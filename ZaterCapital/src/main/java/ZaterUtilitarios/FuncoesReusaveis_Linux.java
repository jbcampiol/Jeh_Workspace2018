...
public class FuncoesReusaveis_Linux {
	...
	public static void InitBrowser(String browserName) throws Exception {
		...
		case "Chrome":
			...
			String Chrome_Browser = Dados_Linux.Browser_Chrome;
		...
		case "Firefox":
			...
			String Firefox_Browser = Dados_Linux.Browser_Firefox;
		...
		case "IE":
			// SETUP do Browser IE
			String IE_Browser = Dados_Linux.Browser_IE;
		...
		case "Edge":
			// SETUP do Browser IE
			String Edge_Browser = Dados_Linux.Browser_Edge;
		...
		case "Safari":
			// SETUP do Browser IE
			// String Safari_Browser = Dados_Linux.Browser_Safari;
	...
	public static String TakeScreenshot(String Resultado, String nameImage) throws Exception {
		...
		case "Sucesso":
			...
			PATH = "/Selenium/ZaterCapital/Selenium WebDriver/Reports/ScreenShot/ZaterCapital/" + dateFormat_pasta.format(date) + "/Sucesso/";
		...
		case "Erro":
			...
			// Informando o diretorio
			PATH = "/Selenium/ZaterCapital/Selenium WebDriver/Reports/ScreenShot/ZaterCapital/" + dateFormat_pasta.format(date) + "/Erro/";
	...
	public static void StartReport(String NomeArquivo){
		...
		// Informando o diretorio
		PATH = "/Selenium/ZaterCapital/Selenium WebDriver/Reports/Regressao/";
		...
		directory = new File(PATH);
			...
			if (!directory.exists()) // Condicao verificando o diretorio
			{
				...
				// Funcao para gerar o HTML
				htmlReporter = new ExtentHtmlReporter("/Selenium/ZaterCapital/Selenium WebDriver/Reports/Regressao/" + NomeArquivo + ".html");
	...
	public static String Json (String URL) throws Exception {
		...
		// Chamando o Browser
		// SETUP do Browser Chrome
		String Chrome_Browser_New = Dados_Linux.Browser_Chrome;
		...
		if (url_site.equals(url_dados)) {
			...
			// Buscar o elemento na página
			String informacao = driver_new.findElement(By.xpath("/html/body/pre")).getAttribute("innerText");		
	...
	public static String RequestURL() throws IOException, Exception {
		...
		// Inserir a URL
		String url = Dados_Linux.Homologacao_JSON;
	...
	public static void QRCode1() throws IOException, NotFoundException, ChecksumException, FormatException { // Não está em uso
		
		String code = "";
		//String imgPath = 
		
		String imgPath = "/Selenium/ZaterCapital/Selenium WebDriver/QRCode/chart.jpg";
