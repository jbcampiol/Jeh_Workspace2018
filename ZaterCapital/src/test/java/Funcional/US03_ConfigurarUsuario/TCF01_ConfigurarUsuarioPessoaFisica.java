...
public class TCF01_ConfigurarUsuarioPessoaFisica extends FuncoesReusaveis_Windows {
	...
	public void um_usuario_do_tipo_Pessoa_Fisica() throws Throwable {
		...
		/** Report Extent **/
		StartReport("TCF01_ConfigurarUsuarioPessoaFisica_TestResult_" + dateFormat.format(date));	
		test = extent.createTest("TCF01_ConfigurarUsuarioPessoaFisica_Iniciar");
		...
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCF01_ConfigurarUsuarioPessoaFisica_Iniciar-AbrirSiteComSucesso"));
		/** Report Extent **/
		...
		if (url_site.equals(url_dados) && IsElementPresent("btn-logar")) {	// || IsElementPresent("Zater Capital")
			...
			test.addScreenCaptureFromPath(TakeScreenshot("Erro","TCF01_ConfigurarUsuarioPessoaFisica_Iniciar-ErroAbrirSite"));
			/** Report Extent **/
	...
	public void informar_os_Dados_e_na_Tela_de_CONFIGURACOES(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8, String arg9) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new PendingException();
		...
		if(IsElementPresent("cpf")) {
			...
			test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-DadosPessoaFisicaVisivel"));
			/** Report Extent **/
			...
			if(IsElementPresent("name")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirNome"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirNomeNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("lastname")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirSobrenome"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirSobrenomeNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("birthday")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirNascimento"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirNascimentoNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("address")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirEndereco"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirEnderecoNaoVisivel"));
				/** Report Extent **/
			...
			if (IsElementSelected("countryField")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirEstado"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirEstadoNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("city")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCidade"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCidadeNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("cep")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCEP"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCEPNaoVisivel"));
				/** Report Extent **/
			...
			if(IsElementPresent("cellphone")) {
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCelular"));
				/** Report Extent **/
				...
				test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirCelularNaoVisivel"));
				/** Report Extent **/
			...
			if (IsElementPresent("//*[@class='col-md-6 ng-hide']")) {
				...
				if(IsElementPresent("impr") && IsElementEnabled("impr")) {
					...
					test.addScreenCaptureFromPath(TakeScreenshot("Sucesso", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirIR"));
					/** Report Extent **/
					...
					test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-AlterarInserirIRNaoVisivel"));
					/** Report Extent **/
			...
			test.addScreenCaptureFromPath(TakeScreenshot("Erro", "STP06_Navegar_Configuracoes_Dados_PessoaFisica-DadosPessoaFisicaNaoVisivel"));
			/** Report Extent **/
	...
	public void o_sistema_deve_permitir_a_atualização_dos_dados_cadastrais_do_usuario_com_sucesso_e_alterar_o_nivel_do_usuario() throws Throwable {
		...
		/** Report Extent **/
		test = extent.createTest("TCF01_ConfigurarUsuarioPessoaFisica_Finalizar");
		test.assignCategory("Regressão");
		/** Report Extent **/
                
		/** Report Extent **/
		test.log(Status.PASS, "Browser Encerrado com Sucesso");
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCF01_ConfigurarUsuarioPessoaFisica_Finalizar-EncerrarSiteComSucesso"));
		/** Report Extent **/
