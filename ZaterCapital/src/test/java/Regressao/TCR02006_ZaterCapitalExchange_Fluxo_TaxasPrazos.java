...
public class TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos  extends FuncoesReusaveis_Windows { 
	...
	public static void AbrirBrowser() throws Exception {
		...
		/** Report Extent **/
		StartReport("TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_TestResult");
		test = extent.createTest("TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Iniciar");
		...
		/** Report Extent **/
		test.log(Status.INFO, "TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Iniciar");
		test.log(Status.PASS, "Browser Carregado com Sucesso");	
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Iniciar-AbrirSiteComSucesso"));
		/** Report Extent **/
		...
		/** Report Extent **/
			...
			test.addScreenCaptureFromPath(TakeScreenshot("Erro","TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Iniciar-ErroAbrirSite"));
			/** Report Extent **/
	...
	@Test
	public void STP03_000_Navegar_Taxas_Prazos() throws Exception {
	...
	public static void FecharBrowser() throws Exception {
		...
		/** Report Extent **/
		test = extent.createTest("TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Finalizar");
		test.assignCategory("Regressão");
		/** Report Extent **/
                
		/** Report Extent **/
		test.log(Status.PASS, "Browser Encerrado com Sucesso");
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCR02006_ZaterCapitalExchange_Fluxo_TaxasPrazos_Finalizar-EncerrarSiteComSucesso"));
		/** Report Extent **/
