...
public class TCR02007_ZaterCapitalExchange_Fluxo_Suporte  extends FuncoesReusaveis_Windows { 
	...
	public static void AbrirBrowser() throws Exception {
		...
		/** Report Extent **/
		StartReport("TCR02007_ZaterCapitalExchange_Fluxo_Suporte_TestResult");
		test = extent.createTest("TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Iniciar");
		...
		/** Report Extent **/
		test.log(Status.INFO, "TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Iniciar");
		test.log(Status.PASS, "Browser Carregado com Sucesso");	
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Iniciar-AbrirSiteComSucesso"));
		/** Report Extent **/
		...
		/** Report Extent **/
			...
			test.addScreenCaptureFromPath(TakeScreenshot("Erro","TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Iniciar-ErroAbrirSite"));
			/** Report Extent **/
	...
	@Test
	public void STP03_000_Navegar_Suporte() throws Exception {
	...
	public static void FecharBrowser() throws Exception {
		...
		/** Report Extent **/
		test = extent.createTest("TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Finalizar");
		test.assignCategory("Regressão");
		/** Report Extent **/
                
		/** Report Extent **/
		test.log(Status.PASS, "Browser Encerrado com Sucesso");
		test.addScreenCaptureFromPath(TakeScreenshot("Sucesso","TCR02007_ZaterCapitalExchange_Fluxo_Suporte_Finalizar-EncerrarSiteComSucesso"));
		/** Report Extent **/
